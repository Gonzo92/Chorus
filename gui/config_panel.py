# ============================================================
#  Chorus v2.5  –  gui/config_panel.py
#  Configuration panel: device serials, phone numbers, timing,
...
RED    = "#ff8585"
CYAN   = "#33e3ff"
MONO, SANS = "Consolas", "Segoe UI"  # fallback
...
class ConfigPanel:
    ...
    @property
    def v_rnum(self): return self._v_rnum
    @property
    ...
    @property
    def v_wait(self): return self._v_wait
    @property
    ...
    @property
    def v_uppercase(self): return self._v_uppercase
    @property
    ...
    def _build(self, parent):
        ...
        self._dut_entries = [
            ...
            self._number_entry_row(self._s1, "MT number", self._v_enum, "dut"),
        ]
        ...
        self._ref_entries = [
            ...
            self._number_entry_row(self._s2, "MT number", self._v_rnum, "ref"),
        ]
        ...
        self._v_wait  = tk.StringVar(value=str(cfg.CALL_END_WAIT))
        ...
        self._entry_row(s3, "End wait (s)", self._v_wait,  width=6)
        ...
        self._v_uppercase = tk.BooleanVar(value=cfg.UPPERCASE_TEXT)
        tk.Checkbutton(df, text="UPPERCASE TEXT",
                       variable=self._v_uppercase,
